...
namespace HTraceWSGI.Editor
{
	...
	internal class HTraceWSGIEditor : UnityEditor.Editor
	{
		...
		SerializedProperty ReflectionIndirectLightingData;
		...
		private void PropertiesRelative()
		{
			...
			ReflectionIndirectLightingData = serializedObject.FindProperty("ReflectionIndirectLightingData");
			...
			// Reflection Indirect Lighting Tab
			IndirectEvaluationMethod = ReflectionIndirectLightingData.FindPropertyRelative("IndirectEvaluationMethod");
			RayBias                  = ReflectionIndirectLightingData.FindPropertyRelative("_rayBias");
			MaxRayLength             = ReflectionIndirectLightingData.FindPropertyRelative("_maxRayLength");
			SpatialRadius            = ReflectionIndirectLightingData.FindPropertyRelative("SpatialRadius");
			JitterRadius             = ReflectionIndirectLightingData.FindPropertyRelative("_jitterRadius");
			TemporalJitter           = ReflectionIndirectLightingData.FindPropertyRelative("TemporalJitter");
			OcclusionCheck           = ReflectionIndirectLightingData.FindPropertyRelative("OcclusionCheck");
		}
	}
}
#endif
