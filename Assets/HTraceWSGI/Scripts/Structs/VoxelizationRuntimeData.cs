...
namespace HTraceWSGI.Scripts.Structs
{
	...
	internal static class VoxelizationRuntimeData
	{
		...
		public static HTraceDirectionalCamera FakeDirectionalCamera { get; set; } = null;
		...
		public static bool                EvaluateHitLighting;
		public static bool                VoxelizationModeChanged; //When we switch mode we got many errors with non alloc textures  
		...
		public static bool CheckBounds(float voxelDensity, int voxelBounds, int overrideBoundsHeight)
		{
